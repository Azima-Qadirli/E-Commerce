...
using MiniE_Commerce.Application.Abstractions.Storage.Local;
...
namespace MiniE_Commerce.Infrastructure.Services.Storage.Local
{
    public class LocalStorage : Storage, ILocalStorage
    {
        ...
        async Task<bool> CopyFileAsync(string path, IFormFile file)
        {
            try
            {
                using FileStream fileStream = new(path, FileMode.Create, FileAccess.Read, FileShare.None, 1024 * 1024, useAsync: false);
