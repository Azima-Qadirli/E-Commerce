...
namespace MiniE_Commerce.Persistence.Migrations
{
    ...
    [Migration("20250305195210_mig_8")]
    partial class mig_8
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniE_Commerce.Domain.Entities.CompletedOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MiniE_Commerce.Domain.Entities.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MiniE_Commerce.Domain.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("MiniE_Commerce.Domain.Entities.Endpoint", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MiniE_Commerce.Domain.Entities.CompletedOrder", b =>
                {
                    b.HasOne("MiniE_Commerce.Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("MiniE_Commerce.Domain.Entities.CompletedOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MiniE_Commerce.Domain.Entities.Endpoint", b =>
                {
                    b.HasOne("MiniE_Commerce.Domain.Entities.Menu", "Menu")
                        .WithMany("Endpoints")
